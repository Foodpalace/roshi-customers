...
//#region node_modules/.nitro/vite/services/ssr/assets/quote-DwhanSpc.js
...
var quoteCart_createServerFn_handler = createServerRpc({
	id: "06af4eb626dbd302bf40958362cfa97a9b98424ce26e624a46c1872e64c70b01",
	name: "quoteCart",
	filename: "src/lib/server/quote.ts"
}, (opts) => quoteCart.__executeServer(opts));
var quoteCart = createServerFn({ method: "POST" }).validator((input) => input).handler(quoteCart_createServerFn_handler, async ({ data }) => {
	return (await buildQuote(data, Boolean(data.isFirstOrder))).result;
});
var trackAnalytics_createServerFn_handler = createServerRpc({
	id: "973e5ed0e3e794113873176663114003cb50bfc713d159f2d72f48c1965b0e71",
	name: "trackAnalytics",
	filename: "src/lib/server/quote.ts"
}, (opts) => trackAnalytics.__executeServer(opts));
var trackAnalytics = createServerFn({ method: "POST" }).validator((input) => input).handler(trackAnalytics_createServerFn_handler, async ({ data }) => {
	if (!(/* @__PURE__ */ new Set([
		"app_open",
		"location_selected",
		"search",
...
//#endregion
export { quoteCart_createServerFn_handler, trackAnalytics_createServerFn_handler };
