export const en = {
  ...
  home: {
    ...
    sampleBanner:
      "Sample catalogue. These kitchens are not live vendors. Every card is marked Sample until a real kitchen is verified.",
  ...
  checkout: {
    ...
    upiVpa: "UPI ID (sandbox)",
    upiVpaPlaceholder: "name@okaxis",
    upiConfirm: "Confirm sandbox payment",
    sandboxBadge: "Sandbox — no money moves",
  },
  orders: {
    title: "Orders",
    empty: "No orders yet",
  ...
  support: {
    ...
    whatsapp: "WhatsApp",
    whatsappHint: "Opens a chat with support. This is not a live kitchen line until a number is connected.",
    whatsappMissing: "WhatsApp is an adapter. No support number is connected yet.",
  },
  auth: {
